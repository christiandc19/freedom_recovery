...
import medicalProfessional from '../../assets/zip-03-smiling-business-man-using-digital-tablet-in-the-o-MQF8K3B.png'
...
function AccordionProps() {
  const accordionItems = [
    ...
    },
    {
      ...
      content: 'At Antioch, we believe in treating both the mind and body. Our mental health recovery programs incorporate therapy, counseling, and wellness activities to foster healing and balance. Whether you are dealing with depression, anxiety, or trauma, our team is here to guide you every step of the way.'
    },
    {

    ...
    <>
        ...
        <div className='privacyPolicySection container'>
            ...
            <div className='privacyPolicySectionContent'>
                    ...
                    <br/>
                    <p><b>Freedom Recovery</b> ("we," "us," or "our") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website https://FreedomRecovery.biz/ (the "Site"). Please read this Privacy Policy carefully. If you do not agree with the terms of this Privacy Policy, please do not access the Site.</p>
            </div>
            ...
            <div className='privacyPolicyBullet'>
                ...
                <p>You may opt out of text messaging at any time by replying to any message with STOP or contacting us at Info@FreedomRecovery.biz. This will end the communications from that particular phone number. You may continue to receive service-related and other non-marketing text messages from other phone numbers managed by Company, and you may opt out of those in a similar fashion.
                </p>
            </div>
